...
MONGODB_URI=mongodb+srv://joycexu888:w4o0UJl7J07vdKgf@lyratech.0ci5hsw.mongodb.net/?retryWrites=true&w=majority&appName=LyraTech
...
console.log('MongoDB URI已成功设置');
console.log('MongoDB密码已成功设置为: w4o0UJl7J07vdKgf'); 