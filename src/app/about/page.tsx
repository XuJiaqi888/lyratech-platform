    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50">
      ...
      <nav className="bg-white shadow-md px-6 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-8">
          ...
          <Link href="/about" className="text-teal-600 font-medium">About Us</Link>
          <Link href="/register" className="text-gray-700 hover:text-teal-600">Get Started</Link>
          <Link href="/signin" className="text-gray-700 hover:text-teal-600">Sign In</Link>
        </div>
      </nav>
      ...
      <div className="py-16 bg-gradient-to-r from-teal-600 to-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white text-lg mb-8 max-w-2xl mx-auto">
            Join our community of ambitious women who are transforming their tech careers and shaping the future of technology.
          </p>
